"""
    ...
    (ANRM 1.0) originally published in [Irvin,NECRO2014]_.
    ...
    This file contains functions that implement the parts of the extrinsic
    apoptosis pathway and activation of a necroptosis reporter proteins, PARP and
    MLKL.
    ...
    Parameters and Initial Conditions were taken from those listed Jurket Cell 
    studies:
    Hua, F., M. Cornejo, M. Cardone, C. Stokes, D. Lauffenburger
    J Immunol 2005; 175:985-995
    ------???Albeck and Sorger???-----
    --concentrations listed in this were converted to copies per cell using an 
    assumed cell volume of 8e-13L 
    http://bionumbers.hms.harvard.edu/bionumber.aspx?&id=104668&ver=2
    --
    """
...
def observables():
    ...
    Observable('RIP3_po4', RIP3(state = 'po4'))
